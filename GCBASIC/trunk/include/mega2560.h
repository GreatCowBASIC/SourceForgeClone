...
#define ANALOG_6 PORTF.5
#define ANALOG_7 PORTF.5
...
#define DIGITAL_14 PORTJ.1
#define DIGITAL_15 PORTJ.0
...
#define DIGITAL_44 PORTL.5
#define DIGITAL_45 PORTL.4
#define DIGITAL_46 PORTL.3
#define DIGITAL_47 PORTL.2
#define DIGITAL_48 PORTL.1
#define DIGITAL_49 PORTL.0

#define DIGITAL_50 PORTB.3
#define DIGITAL_51 PORTB.2
#define DIGITAL_52 PORTB.1
#define DIGITAL_53 PORTB.0
