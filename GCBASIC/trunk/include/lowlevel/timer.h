...
#script
	  ...
	  If PIC Then
			if NOT TMR0_16BIT then 'Test for 16Bit timer0 mode
		 				Timer0  = TMR0
    	end if
  	End If
...
Function Timer0 As Word  'Added to support 16-bit mode
    ...
    #ifdef TMR0_16BIT
      #Ifdef Bit(T08BIT)
        [byte]Timer0 = TMR0L  'Return a 16bit value
        Timer0_H = TMR0H      'Return a 16bit value
      #endif
    #endif

   'added 29/12/2015
    #ifndef TMR0_16BIT
      Timer0 = TMR0    'Return an 8bit value
    #endif
  #endif
