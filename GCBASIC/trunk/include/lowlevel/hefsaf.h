  ...
  #IFDEF HAS_HEFSAF TRUE
     ...
     'SameVars & Bits for 16F Family 15
      ...
      #SameBit NVMREGS, CFGS
       ...
       'Equates
      #DEFINE SAFEraseBlock HEFEraseBlock
      #DEFINE SAFReadBlock HEFReadBlock
      #DEFINE SAFWriteBlock  HEFWriteBLock
      #DEFINE SAFRead HEFRead
      #DEFINE SAFWrite HEFWrite
      #DEFINE SAFWriteWord HEFWriteWord
      #DEFINE SAFReadWord HEFReadWord
