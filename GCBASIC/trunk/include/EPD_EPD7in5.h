...
sub   UpdatePageData_EPD7in5
    ...
    for EPD_Ind_raw=1 to BUFFWIDTH #IGNOREWARNING
       'replaced with macro for speed
        ...
        #ifdef SPISRAM_TYPE
          SRAMRead ( [long]EPD_Ind_raw, [byte]EPD7in5_Data_Black )  'The subroutine method
          'EPD7in5_Data_Black = SRAMRead ( EPD_Ind_raw )
        #endif
        #ifndef SPISRAM_TYPE
