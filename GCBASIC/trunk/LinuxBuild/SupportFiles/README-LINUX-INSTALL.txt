...
This instructions are not distribution specific, but are for Linux only (not Winows).
...
6. You'll need root privileges for this step. You can switch user (su) to root, or optionally use 'sudo'.
