...
Sub BuildAsmSymbolTable
	...
	FOR PD = 1 to SVC
		ASMSym = ASMSym + 1
		ASMSymbols(ASMSym, 1) = Trim(UCase(SysVars(PD, 1)))
		ASMSymbols(ASMSym, 2) = Trim(SysVars(PD, 2))
	NEXT
		
	'SFR bits
	FOR PD = 1 to SVBC
		ASMSym = ASMSym + 1
		ASMSymbols(ASMSym, 1) = Trim(UCase(SysVarBits(PD, 1)))
		ASMSymbols(ASMSym, 2) = Trim(SysVarBits(PD, 2))
	NEXT
