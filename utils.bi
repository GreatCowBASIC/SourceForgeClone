...
FUNCTION GetByte (DataSource As String, BS As Integer) As String
	...
	If Left(DataSource, 1) = "@" Then
		...
		Else
			Print "Unsupported family, GetByte"
	...
	'Convert to decimal
	IF DataSource = Str(VAL(DataSource)) THEN OutVal = VAL(DataSource)
...
Function ReplaceToolVariables(InData As String, FNExtension As String = "", FileNameIn As String = "") As String
