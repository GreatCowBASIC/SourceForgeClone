...
'Namespace Great_Cow_Simulator
	...
	Public Class LowLevel
		...
		Public Shared Function Other2Dec(ByVal InVal As String, ByVal InBase As Integer) As Integer
			Return Utils.Other2Dec(InVal, InBase)
		End Function
	End Class
	...
	Public Class Utils
		...
		Public Shared Function ReplaceToolVariables(InData As String, Optional FNExtension As String = "", Optional FileNameIn As String = "") As String
			...
			'Dim FileNoPath, PathNoFile As String
			Dim PD As Integer
			OutData = InData
			...
			Do While OutData.ToUpper.IndexOf("%APPDATA%") <> -1: Replace (OutData, "%appdata%", GetEnvironmentVariable("APPDATA")): Loop
			Do While OutData.ToUpper.IndexOf("%ALLUSERSAPPDATA%") <> -1: Replace (OutData, "%allusersappdata%", GetEnvironmentVariable("ALLUSERSPROFILE") + "\Application Data"): Loop
			Do While OutData.ToUpper.IndexOf("%TEMP%") <> -1: Replace (OutData, "%temp%", GetEnvironmentVariable("TEMP")): Loop
