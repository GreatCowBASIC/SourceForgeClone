...
'Namespace Great_Cow_Graphical_BASIC
	...
	Public Class PreferencesWindow
		...
		Private Sub InitializeComponent()
			...
			AddHandler Me.DefaultCompilercomboBox.SelectedIndexChanged, AddressOf Me.DefaultCompilercomboBoxSelectedIndexChanged
			'
			'CompilerNoRecompile
			'
		...
		Public Sub HideGCGBOptions
			...
			CompilerSelectionBox.Visible = True
		End Sub
		...
		Sub DefaultCompilercomboBoxSelectedIndexChanged(sender As Object, e As EventArgs)
			If 1 = 1 Then
