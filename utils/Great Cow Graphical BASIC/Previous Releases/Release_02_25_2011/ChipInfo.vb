...
Namespace Great_Cow_Graphical_BASIC
	...
	Public Class ChipInfo
		...
		Public Dim ConfigSettings as ArrayList
		Public Dim NoConfig As Integer
		
		'Stores pinout
		Public Dim PinList As ArrayList
		Public Dim PackageType As String
		
		'Stores interrupts
		Public Dim InterruptList As ArrayList
		...
		Public Sub New(ChipName As String)
			...
			Catch
				...
				If Not ChipNotValid Then
					MessageBox.Show("The chip model currently selected for this program is not valid. Please double check that the model of chip is correct.", "Great Cow Graphical BASIC", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1)
					ChipNotValid = True
				End If
			End Try
