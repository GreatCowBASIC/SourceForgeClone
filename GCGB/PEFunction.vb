			...
			Else If fnSourceList.SelectedIndex > 1 Then
				...
				For Each searchSub In CheckLib.Subroutines
					If searchSub.IsFunction And Not searchSub.HideSub Then
						...
						CaptionWithSource = searchSub.Description
						If searchSub.IncludedFrom <> "" Then
							CaptionWithSource = (searchSub.Description + " (From " + searchSub.IncludedFrom + ")").Trim
						End If
						If Lowlevel.CanCopy(searchSub.ReturnType, ParamType) Then functionList.Add(New CaptionedListItem(searchSub.Name, searchSub.Name, CaptionWithSource, searchSub))
					End If
				Next
			End If
