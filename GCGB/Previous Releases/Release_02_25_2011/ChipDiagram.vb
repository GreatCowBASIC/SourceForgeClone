...
Namespace Great_Cow_Graphical_BASIC
	...
	Public Class ChipDiagram
		...
		Private Sub ChipDiagramPaint(sender As System.Object, e As System.Windows.Forms.PaintEventArgs)
			...
			Dim selectBrush As Brush = Brushes.Red
			...
			pinHeight = chipHeight / (CurrentChip.PinList.Count / 2)
			
			'Decide chip width
			If CurrentChip.PinList.Count > 28 Then
			...
			Dim SecondSide As Integer = CurrentChip.PinList.Count / 2 + 1
