...
''Namespace Great_Cow_Graphical_BASIC
	...
	Public Class HardwareSettings
		...
		Private Dim ChipList As New List(Of String)
		...
		Public Sub New(ByRef CurrentProgram As GCBProgram)
			...
			Dim ChipListTemp As New List(Of String)
...
" not used, it does not have to be set up.")
			Me.HardwarePanel.Location = New System.Drawing.Point(8, 61)
			Me.HardwarePanel.Name = "HardwarePanel"
			Me.HardwareHelp.SetShowHelp(Me.HardwarePanel, true)
			Me.HardwarePanel.Size = New System.Drawing.Size(280, 319)
			...
			Me.AlterChipConfig.Size = New System.Drawing.Size(200, 285)
			...
			Me.ChipSettingsPanel.Location = New System.Drawing.Point(8, 23)
			Me.ChipSettingsPanel.Name = "ChipSettingsPanel"
			Me.HardwareHelp.SetShowHelp(Me.ChipSettingsPanel, true)
			Me.ChipSettingsPanel.Size = New System.Drawing.Size(184, 254)
...
"program is compiled.")
			...
			Me.ChipConfCancel.Location = New System.Drawing.Point(112, 381)
			...
			Me.DeviceSettingsGroup.Size = New System.Drawing.Size(296, 389)
			...
			Me.ChipConfOK.Location = New System.Drawing.Point(16, 381)
		...
		Private Sub RedrawHardwareConfig
			Dim Temp, ValueCount, SearchConst As Integer
				...
				If Not CurrentDevice Is Nothing Then
					For Each CurrentDeviceSetting In CurrentDevice.Settings
						...
						If Not DrawThisItem Then
							...
							CompareConst = TempData.Substring(0, TempData.IndexOf(" ")).ToLower
