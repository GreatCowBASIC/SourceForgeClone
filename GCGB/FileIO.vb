...
''Namespace Great_Cow_Graphical_BASIC
	...
	Public Class FileIO
		Inherits System.Windows.Forms.Form
	  	...
	  	Shared Public Sub LoadCommands
			...
			Dim ItemName As String
		 	...
		 	Dim CurrentDevice As HardwareDevice = Nothing
		 	Dim CurrentDeviceSetting As HardwareDeviceSetting
		 	
		 	Dim CurrentFunction As GCBFunction = Nothing
		 	Dim CurrentConstGroup As ConstGroup = Nothing
		 	Dim CurrentCommand As GCBCommand = Nothing
		 	
		 	MainForm.CommandList = New List(Of GCBCommand)
		 	MainForm.IconCategory = New List(Of String)
		 	 	...
		 	 	ElseIf ReadType = 0 Then
		 			If TempData.IndexOf("=") <> -1 Then
						...
						With CurrentCommand
							...
							If ItemName = "regex" Then .SetRegex(ItemValue)
		...
		Public Shared Sub LoadIcons
			...
			Dim CurrIcon As GCBIcon = Nothing
			
			MainForm.IconList = New List(Of GCBIcon)
