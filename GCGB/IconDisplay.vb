...
Namespace Great_Cow_Graphical_BASIC
	...
	Public Class IconDisplay
		...
		Private Dim Parameters As ArrayList
		...
		Public Sub New(Icon As GCBIcon, Parameters As ArrayList, IconName As String, Optional HideJoiner As Boolean = False, Optional CustomLabel As String = "")
			MyBase.New
		...
		Private Sub IconDisplayPaint(sender As System.Object, e As System.Windows.Forms.PaintEventArgs)
			...
			If Icon.HasJoiner And Not HideJoiner Then
				...
				g.DrawImage(MainForm.JoinerArrow, Convert.ToInt32((Icon.XSize - 20) / 2 * pZoom), Icon.YSize * pZoom)
			End If
					...
					For Temp = 1 To Icon.Lines
			 			If Icon.Line(Temp) <> "" Then
							...
							If labelSize.Width > Icon.XSize Then
								...
								CurrLine = Lowlevel.SplitToFit(CurrLine, labelFont, g, Icon.XSize)
			...
			If pIconSelected Then
				...
				g.DrawRectangle(rectPen, 0, 0, Icon.XSize - 1, Icon.YSize - 1)
			End If
