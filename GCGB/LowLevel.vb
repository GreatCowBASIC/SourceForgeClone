...
Namespace Great_Cow_Graphical_BASIC
	...
	Public Class LowLevel
		...
		Public Shared Function GetCommands(InLine As String) As ArrayList
			Dim OutList As New ArrayList
			Dim CurrCharNo, NextCharNo As Integer
			Dim InQuote, InBinConst As Boolean
			Dim TempBuffer, CurrChar, NextChar As String
			...
			InLine = InLine.Replace(Convert.ToChar(9), " ").Trim
	     	...
	     	If InLine.IndexOfAny(Convert.ToChar(10) + Convert.ToChar(13)) <> -1 Then
	     		...
	     		Dim ThisLine, ThisLineTemp As String
	     		Dim ThisLineCode As ArrayList
		...
		Public Shared Function SplitToFit(CurrLine As String, labelFont As System.Drawing.Font, g As System.Drawing.Graphics, width As Integer) As String
			...
			Dim IconLines As New ArrayList(CurrLine.Split(Environment.NewLine))
